...
집계 단위는 스킬(:data:`gello.instruction_grammar.SKILLS`)이다. 문장 단위로
...
from gello.instruction_grammar import enumerate_instructions, skill_of
from gello.props import Prop
from gello.scene_format import (
    SceneMetadata,
    iter_scene_files,
    list_scene_episodes,
)
