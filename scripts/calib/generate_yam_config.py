...
def main(args: Args) -> None:
    ...
    try:
        ...
        print(
            "Please ensure yam_template.yaml and yam_sim_template.yaml exist in the configs/robots/templates/ directory."
        )
        sys.exit(1)
    ...
    print(
        f"   Hardware: python scripts/launch/launch_yaml.py --left-config-path {hardware_output_path}"
    )
    print(
        f"   Simulation: python scripts/launch/launch_yaml.py --left-config-path {sim_output_path}"
    )
    print()
