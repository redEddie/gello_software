...
def build_center(win) -> None:
    ...
    grid_edit_btn.clicked.connect(win._on_edit_grid)
    ...
    win.speed_combo.currentIndexChanged.connect(win._on_speed_changed)
