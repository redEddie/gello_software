...
def build_configure(win) -> QWidget:
    ...
    win.node_start_btn.clicked.connect(win._on_start_node)
    win.node_stop_btn = QPushButton(tr("노드 종료"))
    win.node_stop_btn.clicked.connect(win._on_stop_node)
